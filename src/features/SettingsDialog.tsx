...
import { Code2, GitCompareArrows, Keyboard, Palette, Plus, RotateCcw, Search, SquareArrowOutUpRight, TriangleAlert, X } from "lucide-react";
    ...
    <Dialog open={!!section} onOpenChange={(o) => !o && setOpen(null)}>
      ...
      >
        <nav className="flex w-48 shrink-0 flex-col gap-0.5 border-r border-border bg-sidebar p-2">
          ...
          <DialogDescription className="sr-only">Appearance, editor, diff, Open in and keyboard shortcut preferences.</DialogDescription>

...
// The terminal's focused pane (terminals.ts registers it): lists importing this don't load xterm.
let focusTerminal: (() => void) | null = null;
export function setTerminalFocus(fn: () => void) {
  focusTerminal = fn;
}
